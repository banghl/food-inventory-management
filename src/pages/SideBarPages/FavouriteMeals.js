...
import { Container, Row, Col, Card, Modal, Button, Pagination } from 'react-bootstrap';
...
function FavouriteMeals() {
  ...
  return (
    <Container fluid className="bg-dark min-vh-100 pt-5" style={{ marginLeft: '90px', marginTop:"90px" }}>
                  ...
                  <Col md={6} lg={4} key={meal.id} className="mb-4">
                    <Card className="h-100 m-auto meal-card">
                      <Card.Body>
                        ...
                        <Button variant="primary" onClick={() => handleClick(meal)}>
                          View Details
                        </Button>
                      </Card.Body>
                    </Card>
